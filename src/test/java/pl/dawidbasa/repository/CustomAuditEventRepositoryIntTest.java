package pl.dawidbasa.repository;

import pl.dawidbasa.RfbloyaltyApp;
import pl.dawidbasa.config.Constants;
import pl.dawidbasa.config.audit.AuditEventConverter;
import pl.dawidbasa.domain.PersistentAuditEvent;
...
import static pl.dawidbasa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
